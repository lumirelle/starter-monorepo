...
To do so, you need to run `bun publish` manually for each package the very first time to create the packages on npm, and then go to `https://www.npmjs.com/package/<your-package-name>/access` to set the connection to your GitHub repo.
